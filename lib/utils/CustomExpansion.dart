...
class _ExpansionTileState extends State<ExpansionTile> with SingleTickerProviderStateMixin {
  ...
  void _handleTap() {
    ...
    //printLogData(_isExpanded.toString());
  }
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    ...
    return Container(
      decoration: BoxDecoration(
          ...
          border: Border(
            top: BorderSide(color: appStore.isDarkMode ? darkModeSecondaryBackgroundDark : borderSideColor),
            bottom: BorderSide(color: appStore.isDarkMode ? darkModeSecondaryBackgroundDark : borderSideColor),
          )),
      child: Column(
            ...
            child: Container(
              ...
              child: ListTile(
                ...
                trailing: widget.trailing ??
                    RotationTransition(
                      turns: _iconTurns,
                      child: Icon(Icons.navigate_next, color: widget.iconColor ?? Colors.grey),
                    ),
              ),
            ),
          ),
