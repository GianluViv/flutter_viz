...
///Divider
const DEFAULT_DIVIDER_HEIGHT = 16.0;
...
/// Image
const DEFAULT_IMAGE_WIDTH = 140.0;
const DEFAULT_IMAGE_HEIGHT = 100.0;
...
///LottieAnimation
const DEFAULT_LOTTIE_ANIMATION_WIDTH = 150.0;
const DEFAULT_LOTTIE_ANIMATION_HEIGHT = 150.0;
...
///SizedBox
const DEFAULT_SIZED_BOX_WIDTH = 16.0;
const DEFAULT_SIZED_BOX_HEIGHT = 16.0;

///Default Page View
const DEFAULT_PAGE_VIEW_HEIGHT = 400.0;
const DEFAULT_PAGE_VIEW_WIDTH = 300.0;
const DEFAULT_PAGE_VIEW_IMAGE_HEIGHT = 300.0;
const DEFAULT_PAGE_VIEW_IMAGE_WIDTH = 200.0;
...
const DEFAULT_RATING_ITEM_SIZE = 30.0;
const DEFAULT_RATED_COLOR = Color(0xFFFFC107);
const DEFAULT_UNRATED_COLOR = Color(0xFF9E9E9E);

///Common Constrained Box
const DEFAULT_CONSTRAINED_MAX_HEIGHT = 100.0;
const DEFAULT_CONSTRAINED_MAX_WIDTH = 100.0;
...
const DEFAULT_PROGRESS_HEIGHT = 3.0;
const DEFAULT_PROGRESS_STROKE_WIDTH = 4.0;
