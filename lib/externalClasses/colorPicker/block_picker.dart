  ...
  static Widget defaultItemBuilder(Color color, bool isCurrentColor, void Function() changeColor) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: color,
        boxShadow: [
          BoxShadow(color: color.withValues(alpha: 0.8), offset: const Offset(1.0, 2.0), blurRadius: 3.0),
        ],
      ),
      child: Material(
...
class _BlockPickerState extends State<BlockPicker> {
  ...
  Widget build(BuildContext context) {
    return widget.layoutBuilder(
      ...
      (Color color, [bool? _, Function? __]) => widget.itemBuilder(color, _currentColor!.toARGB32() == color.toARGB32(), () => changeColor(color)),
    );
  }
}
