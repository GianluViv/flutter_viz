...
mixin _$AppStore on AppStoreBase, Store {
  ...
  bool get isProjectDownloading {
    _$isProjectDownloadingAtom.reportRead();
    return super.isProjectDownloading;
  }
  ...
  bool get isPreviewCode {
    _$isPreviewCodeAtom.reportRead();
    return super.isPreviewCode;
  }

  @override
  set isPreviewCode(bool value) {
    _$isPreviewCodeAtom.reportWrite(value, super.isPreviewCode, () {
      super.isPreviewCode = value;
    });
  }
  ...
  bool get isLoadingScreenData {
    _$isLoadingScreenDataAtom.reportRead();
    return super.isLoadingScreenData;
  }

  @override
  set isLoadingScreenData(bool value) {
    _$isLoadingScreenDataAtom.reportWrite(value, super.isLoadingScreenData, () {
      super.isLoadingScreenData = value;
    });
  }
  ...
  LogicalKeyboardKey? get previousKey {
    _$previousKeyAtom.reportRead();
    return super.previousKey;
  }

  @override
  set previousKey(LogicalKeyboardKey? value) {
    _$previousKeyAtom.reportWrite(value, super.previousKey, () {
      super.previousKey = value;
    });
  }
  ...
  bool get isViewProperty {
    _$isViewPropertyAtom.reportRead();
    return super.isViewProperty;
  }

  @override
  set isViewProperty(bool value) {
    _$isViewPropertyAtom.reportWrite(value, super.isViewProperty, () {
      super.isViewProperty = value;
    });
  }
  ...
  @override
  bool? get isAlignX {
    _$isAlignXAtom.reportRead();
    return super.isAlignX;
  }

  @override
  set isAlignX(bool? value) {
    _$isAlignXAtom.reportWrite(value, super.isAlignX, () {
      super.isAlignX = value;
    });
  }
  ...
  @override
  bool? get isAlignY {
    _$isAlignYAtom.reportRead();
    return super.isAlignY;
  }

  @override
  set isAlignY(bool? value) {
    _$isAlignYAtom.reportWrite(value, super.isAlignY, () {
      super.isAlignY = value;
    });
  }
  ...
  bool? get isPaginationIndicatorAlignX {
    _$isPaginationIndicatorAlignXAtom.reportRead();
    return super.isPaginationIndicatorAlignX;
  }
  ...
  bool? get isPaginationIndicatorAlignY {
    _$isPaginationIndicatorAlignYAtom.reportRead();
    return super.isPaginationIndicatorAlignY;
  }
  ...
  List<String> get codeViewData {
    _$codeViewDataAtom.reportRead();
    return super.codeViewData;
  }

  @override
  set codeViewData(List<String> value) {
    _$codeViewDataAtom.reportWrite(value, super.codeViewData, () {
      super.codeViewData = value;
    });
  }
  ...
  List<String> get widgetCodeData {
    _$widgetCodeDataAtom.reportRead();
    return super.widgetCodeData;
  }

  @override
  set widgetCodeData(List<String> value) {
    _$widgetCodeDataAtom.reportWrite(value, super.widgetCodeData, () {
      super.widgetCodeData = value;
    });
  }
  ...
  int get selectedProperty {
    _$selectedPropertyAtom.reportRead();
    return super.selectedProperty;
  }

  @override
  set selectedProperty(int value) {
    _$selectedPropertyAtom.reportWrite(value, super.selectedProperty, () {
      super.selectedProperty = value;
    });
  }
  ...
  int? get selectedScreenId {
    _$selectedScreenIdAtom.reportRead();
    return super.selectedScreenId;
  }

  @override
  set selectedScreenId(int? value) {
    _$selectedScreenIdAtom.reportWrite(value, super.selectedScreenId, () {
      super.selectedScreenId = value;
    });
  }
  ...
  String? get fileContent {
    _$fileContentAtom.reportRead();
    return super.fileContent;
  }

  @override
  set fileContent(String? value) {
    _$fileContentAtom.reportWrite(value, super.fileContent, () {
  ...
  ScreenListData? get selectedDropdownScreen {
    _$selectedDropdownScreenAtom.reportRead();
    return super.selectedDropdownScreen;
  }
  ...
  WidgetModel? get drawerClass {
    _$drawerClassAtom.reportRead();
    return super.drawerClass;
  }

  @override
  set drawerClass(WidgetModel? value) {
    _$drawerClassAtom.reportWrite(value, super.drawerClass, () {
      super.drawerClass = value;
    });
  }
  ...
  WidgetModel? get appBarClass {
    _$appBarClassAtom.reportRead();
    return super.appBarClass;
  }

  @override
  set appBarClass(WidgetModel? value) {
    _$appBarClassAtom.reportWrite(value, super.appBarClass, () {
      super.appBarClass = value;
    });
  }
  ...
  WidgetModel? get bottomNavigationBarClass {
    _$bottomNavigationBarClassAtom.reportRead();
    return super.bottomNavigationBarClass;
  }
  ...
  WidgetModel? get rootView {
    _$rootViewAtom.reportRead();
    return super.rootView;
  }

  @override
  set rootView(WidgetModel? value) {
    _$rootViewAtom.reportWrite(value, super.rootView, () {
  ...
  List<WidgetModel> get parentWidgetsList {
    _$parentWidgetsListAtom.reportRead();
    return super.parentWidgetsList;
  }

  @override
  set parentWidgetsList(List<WidgetModel> value) {
    _$parentWidgetsListAtom.reportWrite(value, super.parentWidgetsList, () {
      super.parentWidgetsList = value;
    });
  }
  ...
  List<WidgetModel> get selectedWidgetList {
    _$selectedWidgetListAtom.reportRead();
    return super.selectedWidgetList;
  }

  @override
  set selectedWidgetList(List<WidgetModel> value) {
    _$selectedWidgetListAtom.reportWrite(value, super.selectedWidgetList, () {
      super.selectedWidgetList = value;
    });
  }
  ...
  @override
  set screenList(List<ScreenListData> value) {
  ...
  WidgetModel? get currentSelectedWidget {
    _$currentSelectedWidgetAtom.reportRead();
    return super.currentSelectedWidget;
  }
  ...
  @override
  set menuList(List<MenuWidgetsModel> value) {
  ...
  List<MenuWidgetsModel> get adminMenuList {
    _$adminMenuListAtom.reportRead();
    return super.adminMenuList;
  }

  @override
  set adminMenuList(List<MenuWidgetsModel> value) {
    _$adminMenuListAtom.reportWrite(value, super.adminMenuList, () {
      super.adminMenuList = value;
    });
  }
  ...
  @override
  set mediaList(List<MediaData> value) {
  ...
  bool get isPaddingLock {
    _$isPaddingLockAtom.reportRead();
    return super.isPaddingLock;
  }

  @override
  set isPaddingLock(bool value) {
    _$isPaddingLockAtom.reportWrite(value, super.isPaddingLock, () {
      super.isPaddingLock = value;
    });
  }
  ...
  bool get isRadiusLock {
    _$isRadiusLockAtom.reportRead();
    return super.isRadiusLock;
  }

  @override
  set isRadiusLock(bool value) {
    _$isRadiusLockAtom.reportWrite(value, super.isRadiusLock, () {
      super.isRadiusLock = value;
    });
  }

  late final _$colorAtom = Atom(name: 'AppStoreBase.color', context: context);
  ...
  @override
  bool get isAlign {
    _$isAlignAtom.reportRead();
    return super.isAlign;
  }

  @override
  set isAlign(bool value) {
    _$isAlignAtom.reportWrite(value, super.isAlign, () {
      super.isAlign = value;
    });
  }
  ...
  Alignment? get pageViewAlignment {
    _$pageViewAlignmentAtom.reportRead();
    return super.pageViewAlignment;
  }

  @override
  set pageViewAlignment(Alignment? value) {
    _$pageViewAlignmentAtom.reportWrite(value, super.pageViewAlignment, () {
      super.pageViewAlignment = value;
    });
  }
  ...
  String get valueErrorMsg {
    _$valueErrorMsgAtom.reportRead();
    return super.valueErrorMsg;
  }

  @override
  set valueErrorMsg(String value) {
    _$valueErrorMsgAtom.reportWrite(value, super.valueErrorMsg, () {
      super.valueErrorMsg = value;
    });
  }
  ...
  bool get isLanguageChanged {
    _$isLanguageChangedAtom.reportRead();
    return super.isLanguageChanged;
  }

  @override
  set isLanguageChanged(bool value) {
    _$isLanguageChangedAtom.reportWrite(value, super.isLanguageChanged, () {
      super.isLanguageChanged = value;
    });
  }
...
isLoadingScreenData: ${isLoadingScreenData},
...
selectedDropdownScreen: ${selectedDropdownScreen},
...
currentSelectedWidget: ${currentSelectedWidget},
menuList: ${menuList},
adminMenuList: ${adminMenuList},
mediaList: ${mediaList},
isPaddingLock: ${isPaddingLock},
isRadiusLock: ${isRadiusLock},
color: ${color},
isAlign: ${isAlign},
alignment: ${alignment},
pageViewAlignment: ${pageViewAlignment},
